...
#define SCANCODE_KEY(code)			(scancode_key[g_keyboard_layout][code])
#define SCANCODE_SHIFT_KEY(code)	(scancode_shift_key[g_keyboard_layout][code])
...
static const uint8_t scancode_key[MAX_LAYOUT][MAX_SCANCODE] = {
	[LAYOUT_US] = {
	...
	[LAYOUT_FR] = {
		[0x01] =  27,  [0x02] = '&',  [0x03] = 'e',  [0x04] = '"',  [0x05] = '\'', 
		[0x06] = '(',  [0x07] = '-',  [0x08] = 'e',  [0x09] = '_',  [0x0A] = 'c',  
		[0x0B] = 'a',  [0x0C] = ')',  [0x0D] = '=',  [0x0E] = '\b', [0x0F] = '\t', 
		[0x10] = 'a',  [0x11] = 'z',  [0x12] = 'e',  [0x13] = 'r',  [0x14] = 't',  
		[0x15] = 'y',  [0x16] = 'u',  [0x17] = 'i',  [0x18] = 'o',  [0x19] = 'p',  
		[0x1A] = '^',  [0x1B] = '$',  [0x1C] = '\n', [0x1D] =  0,   [0x1E] = 'q',  
		[0x1F] = 's',  [0x20] = 'd',  [0x21] = 'f',  [0x22] = 'g',  [0x23] = 'h',  
		[0x24] = 'j',  [0x25] = 'k',  [0x26] = 'l',  [0x27] = 'm',  [0x28] = '%',  
		[0x29] = 'u',  [0x2A] =  0,   [0x2B] = '*',  [0x2C] = 'w',  [0x2D] = 'x',  
		[0x2E] = 'c',  [0x2F] = 'v',  [0x30] = 'b',  [0x31] = 'n',  [0x32] = ',',  
		[0x33] = ';',  [0x34] = ':',  [0x35] = '!',  [0x36] =  0,   [0x37] = '*',  
		[0x38] =  0,   [0x39] = ' ',
	},
};

static const uint8_t scancode_shift_key[MAX_LAYOUT][MAX_SCANCODE] = {
	[LAYOUT_US] = {
...
extern uint8_t	g_keyboard_layout;
